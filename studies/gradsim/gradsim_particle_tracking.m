...
%             peak_phase(r,d) = AFFT.maxphase;
        ...
        P.plot_name = ['tracks',num2str(trans_range(1)*100,2),datadir];
        P.fig_handle = fig1;
        P.save_plot();
...
%     xlim([1025.5 1030.35]);
    ...
    P.plot_name = ['microbunches_cosaxis',num2str(trans_range(1)*100,2),datadir];
    P.fig_handle = fig22;
    P.save_plot();
    %
...
xlim([60 180])
P.plot_name = ['fft',num2str(trans_range(1)*100,2),datadir];
P.fig_handle = fig888;
P.save_plot();
...
xlabel('frequency (GHz)')
xlim([115 125])
P.plot_name = ['phase',num2str(trans_range(1)*100,2),datadir];
P.fig_handle = fig999;
P.save_plot();
