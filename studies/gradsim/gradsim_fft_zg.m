...
% limits
plasma_radius = 0.18; % cm (4*0.455, following exp, see below trans_lims)
nslices = 2;
xi_range = [20 0];
freq_lims = [108 128]; % GHz
...
if normalized_frequency_switch
    ...
    ax_handle = gca;
    plot(ax_handle.XLim,[1,1],'b','LineWidth',2)
...
Plotty(gcf,'plots_dir',plots_dir,'plot_name',['fvsg','','']);
